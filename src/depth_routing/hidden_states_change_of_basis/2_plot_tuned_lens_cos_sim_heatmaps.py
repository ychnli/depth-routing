...
# # ── Layout: exact-inch panel placement so cells are truly square ──────────────
# FIG_W      = 6.0
# LMARGIN_IN = 0.48
# RMARGIN_IN = 0.06
# HGAP_IN    = 0.14
...
#         return "-1"
#     elif v < 0:
#         return f"{v:.2f}"[0] + f"{v:.2f}"[2:]  # negative, keep minus and skip the 0.
#     else:
#         return f".{v:.2f}"[2:]  # positive, drop leading zero
